...
function Signup(){
   ...
   async function createNewAccount(event){
        ...
        if(!signupData.password.match(/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/)){
            toast.error("Password should have 6-16 Character long with atleast a number and a special Character ..!!");
            return;
        }
        ...
        // to dispatch create account action
        ...
        <HomeLayout>
            <div className="flex items-center justify-center h-[90vh]">
                <form onSubmit={createNewAccount} noValidate className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]">
                    ...
                    <button type="submit" className="bg-yellow-600 hover:bg-yellow-500 mt-3 transition-all ease-in-out duration-300 rounded-full py-1 font-semibold text-lg cursor-pointer">
                        Create account
                    </button>
